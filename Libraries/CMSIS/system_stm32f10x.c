...
#define VECT_TAB_OFFSET  0x0000 /*!< Vector Table base offset field. 
                                  //This value must be a multiple of 0x200. */
/*
0x8000000           0x800CFF0   0x800D000             0x803F000             0x8071000  0x8071010    0x807FFFF
|----52K(0xCFF0)----|           |----200K(0x32000)-----||-----200K(0x32000)---|          |---------
|----bootloader-----|           |-------Run_APP-------||------NEW_APP-------|          |--升级标志存放----
...
#ifdef  STM32F10X_CL
	uint32_t prediv1source = 0, prediv1factor = 0,
	         prediv2factor = 0, pll2mull = 0;
#endif /* STM32F10X_CL */
#if defined (STM32F10X_LD_VL) || defined (STM32F10X_MD_VL) || (defined STM32F10X_HD_VL)
