                      ...
                      FSMC_NORSRAMInitStruct)
{
	...
	assert_param(IS_FSMC_NORSRAM_BANK(
	                 FSMC_NORSRAMInitStruct->FSMC_Bank));
	assert_param(IS_FSMC_MUX(
	                 FSMC_NORSRAMInitStruct->FSMC_DataAddressMux));
	assert_param(IS_FSMC_MEMORY(
	...
	assert_param(IS_FSMC_WRAP_MODE(
                   ...
                   FSMC_NANDInitStruct)
{
	...
	assert_param(IS_FSMC_TAR_TIME(
	                 FSMC_NANDInitStruct->FSMC_TARSetupTime));
