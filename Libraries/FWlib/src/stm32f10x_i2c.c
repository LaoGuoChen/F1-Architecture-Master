              ...
              I2C_InitTypeDef* I2C_InitStruct)
{
	...
	/* Check the parameters */
	assert_param(IS_I2C_ALL_PERIPH(I2Cx));
	assert_param(IS_I2C_CLOCK_SPEED(
	                 I2C_InitStruct->I2C_ClockSpeed));
	assert_param(IS_I2C_MODE(I2C_InitStruct->I2C_Mode));
	assert_param(IS_I2C_DUTY_CYCLE(
	                 I2C_InitStruct->I2C_DutyCycle));
	assert_param(IS_I2C_OWN_ADDRESS1(
	...
	if(I2C_InitStruct->I2C_ClockSpeed <= 100000)
	{
		...
		result = (uint16_t)(pclk1 / (I2C_InitStruct->I2C_ClockSpeed
		                             << 1));
                             ...
                             uint32_t I2C_FLAG)
{
	...
	if(((*(__IO uint32_t*)i2cxbase) & I2C_FLAG) !=
	    (uint32_t)RESET)
	{
		/* I2C_FLAG is set */
		bitstatus = SET;
...
ITStatus I2C_GetITStatus(I2C_TypeDef* I2Cx, uint32_t I2C_IT)
{
	...
	enablestatus = (uint32_t)(((I2C_IT & ITEN_Mask) >> 16) &
	                          (I2Cx->CR2)) ;
	/* Get bit[23:0] of the flag */
	I2C_IT &= FLAG_Mask;
	/* Check the status of the specified I2C flag */
	if(((I2Cx->SR1 & I2C_IT) != (uint32_t)RESET) &&
	    enablestatus)
	{
		/* I2C_IT is set */
		bitstatus = SET;
